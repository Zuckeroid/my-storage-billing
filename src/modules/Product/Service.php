        ...
        if (isset($data['pricing'])) {
            ...
            if ($data['pricing']['type'] == \Model_ProductPayment::RECURRENT) {
                if (isset($pricing['recurrent']['1W'])) {
                    ...
                    $productPayment->w_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['1W']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['1M'])) {
                    ...
                    $productPayment->m_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['1M']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['3M'])) {
                    ...
                    $productPayment->q_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['3M']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['6M'])) {
                    ...
                    $productPayment->b_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['6M']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['1Y'])) {
                    ...
                    $productPayment->a_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['1Y']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['2Y'])) {
                    ...
                    $productPayment->bia_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['2Y']['enabled'] ?? 0);
                }
                ...
                if (isset($pricing['recurrent']['3Y'])) {
                    ...
                    $productPayment->tria_enabled = $this->normalizeEnabledFlag($pricing['recurrent']['3Y']['enabled'] ?? 0);
                }
            }
